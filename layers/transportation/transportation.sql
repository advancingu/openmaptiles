...
SELECT osm_id,
       ...
       NULLIF(traffic_sign, '') AS traffic_sign
FROM (
         ...
         WHERE zoom_level > 11 AND NOT is_area
           AND
               CASE
--                  TODO This is a big ugly hack until we have filter functions that match our purpose
                    WHEN zoom_level >= 8 THEN TRUE
